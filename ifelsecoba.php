<?php
 $jurusan = [
    [
      "nama" => "RPL",
      "siswa" => [
        ["nama" => "satria", "umur" => "18 tahun", "nilai" => 58],
        ["nama" => "fattah", "umur" => "19 tahun", "nilai" => 77],
      ],
    ],
    ...
    [
      "nama" => "TKR",
      "siswa" => [
          ["nama" => "Raden", "umur" => "16 tahun", "nilai" => 86],
          ["nama" => "Fariz", "umur" => "20 tahun", "nilai" => 9],
      ]
    ]
  ];
 ?>
  ...
  <div class="container my-5">
    ...
    <table class="table">
      ...
      <tbody>
       ...
       <?php foreach ($js ["siswa"] as $siswaa) : ?>
        ...
        if($siswaa['nilai'] >80){
            echo 'table-success' ;
        }else if($siswaa ['nilai'] >= 20 && $siswaa['nilai'] < 80){
            echo 'table-danger' ;
   ...
   ?> ">
          ...
          <?php if ($siswaa ["nilai"] >= 75){
            echo "anjayy lulus";
          }elseif ($siswaa ['nilai'] >= 20 &&  $siswaa['nilai']  < 75){
            echo "yhahahaha mampus remed";
          }elseif($siswaa ['nilai'] < 10){
            echo "waduhhh bahaya";
          } ?>
          </td>
          <td>
